...
public class TopFragment extends Fragment implements OnMovieClickListener {

    private final String LOG_TAG = TopFragment.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mListOfMovies = getTopMoviesSingleton();
    ...
    private void fetchJsonId() {
        String url = createUrl(UriTerms.TOP);

        Log.v(LOG_TAG, "Top url: " + url);
...
//        movie.setBackdropPath(createImageUrl(movieLogan.getBackdropPath(), UriTerms.POSTER_SIZE_ORIGINAL));
    ...
    private void attachAdapter() {
        Log.v(LOG_TAG, "List of top movies: " + getTopMoviesSingleton());

        mRecyclerAdapter = new PosterRecyclerViewAdapter(getTopMoviesSingleton(), this);
