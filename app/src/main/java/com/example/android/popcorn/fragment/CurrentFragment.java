...
public class CurrentFragment extends Fragment implements OnMovieClickListener {

    private final String LOG_TAG = CurrentFragment.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mListOfMovies = getCurrentMoviesSingleton();
    ...
    private void fetchJsonId() {
        String url = createUrl(UriTerms.CURRENT);
...
//        movie.setBackdropPath(createImageUrl(movieLogan.getBackdropPath(), UriTerms.POSTER_SIZE_ORIGINAL));
    ...
    private void attachAdapter() {
        mRecyclerAdapter = new PosterRecyclerViewAdapter(getCurrentMoviesSingleton(), this);
